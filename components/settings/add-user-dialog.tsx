...
import { userAddSchema, UserAddFormData } from '@/lib/validations/settings';
...
import { UserPlus, Shield, ShieldCheck, Crown, Truck, Calculator, User } from 'lucide-react';
...
export function AddUserDialog({
  ...
  const form = useForm<UserAddFormData>({
  ...
  const onSubmit = async (data: UserAddFormData) => {
    setIsSubmitting(true);

    try {
      const result = await createUser(organizationSlug, data);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a user to your organization. This is useful for drivers who won't use the software themselves but need to be in the system for job assignments.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            description="Optional - useful for contacting the user"
          />
